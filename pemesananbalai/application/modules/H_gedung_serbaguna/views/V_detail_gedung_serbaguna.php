                                        ...
                                        <div class="form-group">
                                            <div class="col-md-10">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" data-plugin-datepicker class="form-control" id="cekTanggal">
                                                </div>
                                            </div>
                                            <div class="col-md-2">
...
<script type="text/javascript">
    ...
    function cek_tanggal(){
        ...
        $.ajax({
            type:"POST",
            url: "<?=base_url().'H_gedung_serbaguna/cek_tanggal_detail_tempat'?>",
            data:"tanggal="+tanggal+"&idTempat="+idTempat,
            success: function(hasil) {
                $("#konfirmasi-tanggal").html(hasil);
    ...
    function inputDataPendaftaran(){
        ...
        var fsiang          = $("#fsiang").is(":checked");
        var fsore           = $("#fsore").is(":checked");
        var fmalam          = $("#fmalam").is(":checked");

        $.ajax({
            type:"POST",
            url: "<?=base_url().'H_gedung_serbaguna/insert_data_gedung_serbaguna'?>",
            data:"namaKegiatan="+fnamaKegiatan+"&organisasi="+forganisasi+"&kebutuhan="+fkebutuhan+"&keterangan="+fketerangan+"&tanggal="+tanggal+"&idTempat="+idTempat+"&siang="+fsiang+"&sore="+fsore+"&malam="+fmalam,
            success: function(hasil) {
                
                if (hasil=='berhasil') {
                    window.location.replace('<?=base_url("user/daftar-tempat")?>');
                }else{
                    alert('gagal');
                }
            }
