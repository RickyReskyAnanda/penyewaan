...
class M_gedung_serbaguna extends CI_Model {
    ...
    public function select_data_gedung_serbaguna(){
        $this->db->where('jenis_tempat','gedung-serbaguna');
        ...
        for ($i=0; $i < count($data); $i++) { 
            $data[$i]['link_detail'] = base_url().'gedung-serbaguna/'.$this->teknikal->namakelink($data[$i]['nama_tempat']).'/'.$data[$i]['id_tempat'];
        }

        return $data;
    }
    public function select_load_data_gedung_serbaguna(){
    ...
    public function select_data_detail_gedung_serbaguna(){
    ...
    public function select_data_search_gedung_serbaguna(){
    ...
    public function cek_tanggal_detail_tempat(){
        ...
        return $this->db->get('tabel_waktu')->result_array();
    ...
    public function insert_data_gedung_serbaguna(){
        ...
        $waktu1[0] = $this->input->post('siang');
        $waktu1[1] = $this->input->post('sore');
        $waktu1[2] = $this->input->post('malam');

        $waktu2[0]='siang';
        $waktu2[1]='sore';
        $waktu2[2]='malam';

        for ($i=0; $i < count($waktu1); $i++) {
            if ($waktu1[$i]=='true') {
